...
if (strcmp ($res, "VERIFIED") == 0) {
	...
	if($isPaymentCompleted) {
	    ...
	    $payment_id = $db->insert("INSERT INTO payment(invoice_id, client_id, payment_status, payment_amount, payment_currency, txn_id) VALUES(?, ?, ?, ?, ?, ?)", $param_type, $param_value_array);
	  $db->update("UPDATE invoice SET is_view=3 WHERE id=$item_number");
		$_SESSION['company']['isSubscribe'] = 1;
